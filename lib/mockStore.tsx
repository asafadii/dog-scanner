...
export function MockStoreProvider({ children }: { children: ReactNode }) {
  ...
  const addDog = useCallback((data: NewDogFormData): Dog => {
    ...
    const newDog: Dog = {
      ...
      vaccinationExpiryDate: data.vaccinationExpiryDate.trim() || null,
      aggressionTowardsPeople: data.aggressionTowardsPeople,
      aggressionTowardsDogs: data.aggressionTowardsDogs,
      separationAnxiety: data.separationAnxiety,
      kennelTrained: data.kennelTrained,
      chewingRisk: data.chewingRisk,
      aggressionPeopleNotes: data.aggressionPeopleNotes,
      aggressionDogsNotes: data.aggressionDogsNotes,
      separationAnxietyNotes: data.separationAnxietyNotes,
      chewingRiskNotes: data.chewingRiskNotes,
      medicationNotes: data.medicationNotes,
      allergyNotes: data.allergyNotes,
      dietaryNotes: data.dietaryNotes,
      feedingSource: data.feedingSource,
      feedingMealsPerDay: data.feedingSource ? data.feedingMealsPerDay : null,
      isReturning: false,
      status: "checked_out",
      alerts: data.alerts,
      owner: {
        ...
        emergencyContact: data.ownerEmergencyContact || data.ownerName,
        emergencyPhone: data.ownerEmergencyPhone || data.ownerPhone,
        veterinarian: "",
        vetPhone: "",
      },
      care: {
        medication: data.medicationNotes || "None",
        allergies: data.allergyNotes || "None known",
        dietaryNotes: data.dietaryNotes || "None",
        feedingSource: data.feedingSource,
        feedingMealsPerDay: data.feedingSource ? data.feedingMealsPerDay : null,
        feedingNotes: data.feedingNotes || "None",
